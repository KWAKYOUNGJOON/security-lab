...
- compared_run_id: `N/A`
- run_mode: `single`
- generated_at: `2026-03-15T08:26:59+00:00`
...
- 증거 요약: Nuclei request captured in result output.; artifact: .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt; artifact: .tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_request.txt
- 재현/확인 포인트: .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt; HTTP/1.1 200 OK; Content-Type: text/html; .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_response.txt
...
- 증거 요약: Nuclei request captured in result output.; artifact: .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt; artifact: .tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_request.txt
- 재현/확인 포인트: .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt; HTTP/1.1 200 OK; Content-Type: text/html; .tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_response.txt
...
### Artifact 참조 인덱스
- F-0001 request: raw=`.tmp_run\phase10-archive-demo\artifacts\burp\raw\burp_001_error-disclosure_request.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\burp\redacted\burp_001_error-disclosure_request.txt`
- F-0001 response: raw=`.tmp_run\phase10-archive-demo\artifacts\burp\raw\burp_001_error-disclosure_response.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\burp\redacted\burp_001_error-disclosure_response.txt`
- F-0002 request: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_001_directory-listing_request.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_001_directory-listing_request.txt`
- F-0002 response: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_001_directory-listing_response.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_001_directory-listing_response.txt`
- F-0003 request: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_request.txt`
- F-0003 response: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_response.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_response.txt`
- F-0004 request: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_003_reflected-xss_request.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_003_reflected-xss_request.txt`
- F-0004 response: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_003_reflected-xss_response.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_003_reflected-xss_response.txt`
- F-0005 request: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_request.txt`
- F-0005 response: raw=`.tmp_run\phase10-archive-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_response.txt` redacted=`.tmp_run\phase10-archive-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_response.txt`

### Decision Trace 요약
- `.tmp_run\phase10-archive-demo\report_data\final_report_bundle.json`
- `.tmp_run\phase10-archive-demo\report_data\mapping_decisions.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\scoring_decisions.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\override_decisions.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\cluster_decisions.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\suppression_decisions.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\review_queue.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\review_resolution_applied.jsonl`
- `.tmp_run\phase10-archive-demo\report_data\review_closure_status.json`
- `.tmp_run\phase10-archive-demo\report_data\qa_metrics.json`
- `.tmp_run\phase10-archive-demo\report_data\remediation_policy_decisions.json`
- `.tmp_run\phase10-archive-demo\report_data\ingest_manifest.json`
