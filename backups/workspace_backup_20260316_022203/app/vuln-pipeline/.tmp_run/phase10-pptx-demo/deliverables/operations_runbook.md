...
- run_root: `.tmp_run\phase10-pptx-demo`
...
## Review Flow
1. Apply override file: `D:\취약점 진단\data\inputs\manual\sample_override.yaml`
2. Apply suppression file: `D:\취약점 진단\data\inputs\manual\suppressions.yaml`
3. Apply review resolution file: `D:\취약점 진단\data\inputs\manual\review_resolution.yaml`
...
## Troubleshooting
- Current preflight status: `blocked`
