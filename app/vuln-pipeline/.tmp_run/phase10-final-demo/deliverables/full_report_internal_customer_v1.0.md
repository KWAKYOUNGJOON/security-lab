...
- compared_run_id: `phase10-pptx-demo`
- run_mode: `single`
...
## 3. 이전 실행 대비 변화
- 비교 기준 run_id: `phase10-pptx-demo`
- 신규 이슈: 2
- 해결 이슈: 2
- 변경 이슈: 0
- 유지 이슈: 0
...
## 4. Executive Summary
내부 검토용으로 기술 근거와 운영 판단 포인트를 함께 정리했습니다. 이번 실행에서는 총 2건의 보고 대상 이슈가 확인되었고 High 이상은 1건입니다. 우선 조치 대상은 reflected xss, potential input reflection이며, 현재 1개 자산 범위에서 영향이 확인되었습니다. false positive 1건은 본문에서 제외했습니다. suppression 1건은 운영 기준에 따라 별도 관리합니다. 이전 실행(phase10-pptx-demo) 대비 신규 2건, 해결 2건 변화가 있습니다. 본 결과는 analyst review가 필요한 자동 분석 산출물입니다. 추가 근거와 재현 검토를 전제로 해석하는 것이 적절합니다.
...
- 증거 요약: Nuclei request captured in result output.; artifact: .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt; artifact: .tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_request.txt
- 재현/확인 포인트: .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt; HTTP/1.1 200 OK; Content-Type: text/html; .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_response.txt
...
- 증거 요약: Nuclei request captured in result output.; artifact: .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt; artifact: .tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_request.txt
- 재현/확인 포인트: .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt; HTTP/1.1 200 OK; Content-Type: text/html; .tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_response.txt
...
### Artifact 참조 인덱스
- F-0001 request: raw=`.tmp_run\phase10-final-demo\artifacts\burp\raw\burp_001_error-disclosure_request.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\burp\redacted\burp_001_error-disclosure_request.txt`
- F-0001 response: raw=`.tmp_run\phase10-final-demo\artifacts\burp\raw\burp_001_error-disclosure_response.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\burp\redacted\burp_001_error-disclosure_response.txt`
- F-0002 request: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_001_directory-listing_request.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_001_directory-listing_request.txt`
- F-0002 response: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_001_directory-listing_response.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_001_directory-listing_response.txt`
- F-0003 request: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_request.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_request.txt`
- F-0003 response: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_002_reflected-xss_response.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_002_reflected-xss_response.txt`
- F-0004 request: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_003_reflected-xss_request.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_003_reflected-xss_request.txt`
- F-0004 response: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_003_reflected-xss_response.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_003_reflected-xss_response.txt`
- F-0005 request: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_request.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_request.txt`
- F-0005 response: raw=`.tmp_run\phase10-final-demo\artifacts\nuclei\raw\nuclei_004_potential-input-reflection_response.txt` redacted=`.tmp_run\phase10-final-demo\artifacts\nuclei\redacted\nuclei_004_potential-input-reflection_response.txt`

### Decision Trace 요약
- `.tmp_run\phase10-final-demo\report_data\final_report_bundle.json`
- `.tmp_run\phase10-final-demo\report_data\mapping_decisions.jsonl`
- `.tmp_run\phase10-final-demo\report_data\scoring_decisions.jsonl`
- `.tmp_run\phase10-final-demo\report_data\override_decisions.jsonl`
- `.tmp_run\phase10-final-demo\report_data\cluster_decisions.jsonl`
- `.tmp_run\phase10-final-demo\report_data\suppression_decisions.jsonl`
- `.tmp_run\phase10-final-demo\report_data\review_queue.jsonl`
- `.tmp_run\phase10-final-demo\report_data\review_resolution_applied.jsonl`
- `.tmp_run\phase10-final-demo\report_data\review_closure_status.json`
- `.tmp_run\phase10-final-demo\report_data\qa_metrics.json`
- `.tmp_run\phase10-final-demo\report_data\remediation_policy_decisions.json`
- `.tmp_run\phase10-final-demo\report_data\ingest_manifest.json`
